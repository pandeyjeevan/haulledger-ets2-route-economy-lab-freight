...
独立的项目设计文档，适用对象： **Euro Truck Simulator 2**。
...
- **路线成本场景** (Route cost scenarios) — 规划模块，尚未实现。
- **车库预算工作表** (Garage budget worksheets) — 规划模块，尚未实现。
- **配置快照说明** (Profile snapshot notes) — 规划模块，尚未实现。
