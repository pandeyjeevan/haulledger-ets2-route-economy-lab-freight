...
<div align="center">
  <img src="./public/logo.svg" alt="HaulLedger — Euro Truck Simulator 2 — Freight" width="64" height="64">
  <h1>HaulLedger — Euro Truck Simulator 2 — Freight</h1>
</div>

An independent project specification for Euro Truck Simulator 2, covering route cost scenarios, garage budget worksheets, profile snapshot notes.
...
<img src="./public/screenshots/desktop-main.svg" alt="Euro Truck Simulator 2 — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Euro Truck Simulator 2 — compact concept, not a screenshot" width="250">
<br>
...
- **Route cost scenarios** — planned module; not implemented.
- **Garage budget worksheets** — planned module; not implemented.
- **Profile snapshot notes** — planned module; not implemented.

The proposed workflow separates route cost scenarios from garage budget worksheets, with profile snapshot notes retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Route cost scenarios**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="HaulLedger — Euro Truck Simulator 2 — Freight — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the Euro Truck Simulator 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Garage budget worksheets

Define the input and expected outcome for module 2. Record the Euro Truck Simulator 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Profile snapshot notes

Define the input and expected outcome for module 3. Record the Euro Truck Simulator 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Euro Truck Simulator 2 |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Route cost scenarios |
